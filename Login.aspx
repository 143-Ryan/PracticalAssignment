...
<head runat="server">
    <title>Login</title>
    <script src="https://www.google.com/recaptcha/api.js?render=6LcGlUUeAAAAAOO13QHBoonWs-v4YTqEfojqkR3Y"></script>
</head>
<body>
    ...
    <script>
        grecaptcha.ready(function () {
            grecaptcha.execute('6LcGlUUeAAAAAOO13QHBoonWs-v4YTqEfojqkR3Y', { action: 'Login' }).then(function (token) {
